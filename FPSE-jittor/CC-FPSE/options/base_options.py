...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # parser.add_argument('--mpdist', action='store_true',
        #                     help='use distributed multiprocessing')
        # parser.add_argument('--dist_url', type=str,
        #                     default='tcp://10.1.72.171:8000')
        ...
        #                     default=8, help='num of gpus for each server')
        parser.add_argument('--name', type=str, default='FPSE_JITTOR',
        ...
        parser.add_argument('--norm_G', type=str, default='spectralsync_batch',
        ...
        parser.add_argument('--netG', type=str,
                            default='condconv', help='model to use for netG')

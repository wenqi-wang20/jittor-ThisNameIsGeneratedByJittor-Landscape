...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--beta2', type=float,
                            default=0.999, help='momentum term of adam')
        ...
        parser.add_argument('--netD', type=str,
                            default='fpse', help='discriminator mode')
        parser.add_argument('--netD_subarch', type=str, default='n_layer',
                            help='(n_layer|dyconv_n_layer|half_dyconv_n_layer)')
        parser.add_argument('--no_TTUR', action='store_true',
                            help='Not use TTUR training scheme')

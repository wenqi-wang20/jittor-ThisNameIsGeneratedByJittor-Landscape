...
python train.py --name spade_bs8 --dataset_mode custom --label_dir ../Jittor/CGAN/train/labels/ --image_dir ../Jittor/CGAN/train/imgs/ --label_nc 29 --no_instance --batchSize 1
```
